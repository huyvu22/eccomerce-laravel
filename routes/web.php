...
Route::prefix('user')->name('user.')->middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('paypal/success',[PaymentController::class,'paypalPaymentSuccess'])->name('paypal.success');
    Route::get('paypal/cancel',[PaymentController::class,'paypalPaymentCancel'])->name('paypal.cancel');
