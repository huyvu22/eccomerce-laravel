        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
                    ...
                    <h4>Ảnh sản phẩm</h4>
                    <h6 class="mb-3">Tên sản phẩm: {{$product->name}}</h6>
                            ...
                            <div class="wsus__dash_pro_area">
                                <form action="{{route('vendor.products-image-gallery.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="mb-2">Tải nhiều ảnh</label>
                                    ...
                                    <button class="btn btn-primary mt-3" style="font-size: 14px">Lưu</button>
                                </form>
                            </div>
                        </div>
                    </div>

                    <h6 class="mt-3 mb-2">Tất cả ảnh</h6>
