                                            ...
                                            <div class="col-xl-6">
                                                <div class="wsus__dash_add_single">
                                                    ...
                                                    <div class="wsus__address_btn">
                                                        <a href="{{route('user.address.edit',$user)}}" class="edit"><i class="fal fa-edit"></i> edit</a>
                                                        <a href="{{route('user.address.destroy',$user)}}" class="del"><i class="fal fa-trash-alt"></i> delete</a>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
