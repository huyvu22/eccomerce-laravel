...
<section id="wsus__large_banner">
    <div class="container">
        <div class="row">
            <div class="cl-xl-12">
                <div class="wsus__large_banner_content" style="background: url({{$homepageBannerSection4->banner_image}});">
                            ...
                            <div class="col-xl-6 col-12 col-md-6">
                                <div class="wsus__large_banner_text">
                                    ...
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Rem repudiandae in
                                        ipsam
                                        nesciunt.</p>
                                    <a class="shop_btn" href="{{$homepageBannerSection4->banner_url}}">view more</a>
                                </div>
                            </div>
                            <div class="col-xl-6 col-12 col-md-6">
